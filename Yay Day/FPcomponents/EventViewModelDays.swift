...
class EventViewModelDays: ObservableObject {
    ...
    private let eventRequest = EventRequest()
    ...
    func fetchFilteredEvents() async {
        await eventRequest.fetchFilteredEvents { result in
            DispatchQueue.main.async {
                switch result {
